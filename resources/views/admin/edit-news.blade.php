                        ...
                        <div class="w-full rounded-md bg-slate-50 p-4 shadow-md">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="text" name="title" id="title"
                                    class="border bg-white border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" value="{{ $data->title }}"
                            ...
                            <div class="mb-2">
                                ...
                                <textarea id="konten" name="konten" rows="4"
                                    class="block p-2.5 w-full  text-gray-900 bg-white rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 text-start">
                                 {{ $data->content }}
                                 </textarea>
                            </div>
